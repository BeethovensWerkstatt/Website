...
Der folgende Abschnitt konzentriert sich auf die Methoden zur Rekonstruktion großformatiger Skizzenbücher, weil das im [4. Modul]({% link _pages/module.md %}#modul-4) betrachtete „[Notirungsbuch K]({% link _publications/zum-notirungsbuch-k.md %})" zu dieser Gruppe gehört. Aufgrund des anderen Aufbaus von Taschenskizzenheften weichen die Techniken zu ihrer Rekonstruktion ab. Sie werden hier nicht weiter ausgeführt.  
