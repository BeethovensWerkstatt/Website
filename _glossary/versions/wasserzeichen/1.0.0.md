...
layout: glossary
title: Wasserzeichen
short_definition: Markantes durch Papier scheinendes Zeichen bei Lichteinfall.
...
doi_version: 10.5281/zenodo.19882209
doi_overview: 10.5281/zenodo.19882208
---
...
Das Papier wurde in Papiermühlen hergestellt. Am Herstellungsprozess waren zwei Personen beteiligt, der Schöpfer und der Gautscher. Der Schöpfer taucht die Schöpfform in einen mit Papierbrei gefüllten Bottich. Als Schöpfform bezeichnet man einen Rahmen, in den ein Drahtgeflecht gespannt ist. Dieses Geflecht hält die festen Teile des Papierbreis, während das Wasser abtropft, sodass sich auf dem Draht eine dünne Papierschicht ablagert. Der Gautscher übernahm die gefüllte Form, wendete die Papierschicht und legte sie auf einem Filz ab (sog. Abgautschen). Damit Schöpfer und Gautscher fließend miteinander arbeiten konnten, wurden zwei Formen parallel verwendet. Die abgelegten Papierbögen wurden dann getrocknet, geleimt und abschließend geglättet. Der aufgetragene Leim verbessert die Struktur der Papieroberfläche.
...
Ein Bogen Papier wurde in der Regel durch horizontales und vertikales Falten und Zerteilen in zwei Doppelblätter oder. vier Blatt Papier unterteilt (s. [Schnittkanten]({% link _glossary/schnittkanten.md %})). Jeder Bogen setzt sich also aus insgesamt vier Quadranten zusammen, die jeweils einen, manchmal auch keinen Teil des Wasserzeichens enthalten.

Ziel einer Wasserzeichenuntersuchung ist, das gesamte Zeichen eines ursprünglich ungeteilten Bogens mit Hilfe aller vier Quadranten zu rekonstruieren.

Das Wasserzeichen wird dabei mit Aufsicht auf die Siebseite, also der beim Schöpfen auf dem Drahtgeflecht liegenden Seite, beschrieben. Die andere Seite, auf der der Gautscher das Papier ablegte, wird als Filzseite bezeichnet. Die einzelnen Quadranten eines Bogens werden dann von links unten im Uhrzeigersinn von 1 bis 4 nummeriert.

Das Wasserzeichen dient der Erkennung verschiedener Papiersorten, -herkunft und der Datierung. So kann es auch für die [Rekonstruktion von Skizzenbüchern]({% link _glossary/rekonstruktion-von-skizzenbuechern.md %}) und die Beschreibung der Lagenstruktur Hinweise liefern. Neben dem Wasserzeichen erfordert die genaue Beschreibung eines Papiers Informationen zu den Abmessungen des Blattes, zur Farbe, zur Rastrierung, evtl zu den [Stichlöchern]({% link _glossary/stichloecher.md %}) und [Schnittkanten]({% link _glossary/schnittkanten.md %}). Da sich die Drahtgebilde der Wasserzeichen mit der Zeit abnutzen, sind aufgrund der dadurch im Wasserzeichen entstehenden Veränderungen mitunter genauere Abstufungen der Datierung möglich.

### Literatur

- Konrad, Ulrich: Wasserzeichen, in: Die Musik in Geschichte und Gegenwart, 2. neubearbeitete Ausgabe, hrsg. von Ludwig Finscher, Sachteil 9 (1998), Sp. 1914–1921.
- Johnson/Tyson/Winter: The Beethoven sketchbooks: history, reconstruction, inventory, hrsg. von Douglas Johnson, Oxford 1985, S. S. 50-54.
- Wolfram Enßlin: Wasserzeichen/Papier, in: Das Beethoven-Lexikon (2008), S. 832–834.
